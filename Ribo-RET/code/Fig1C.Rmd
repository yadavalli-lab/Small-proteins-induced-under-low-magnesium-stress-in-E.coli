...
#Figure 1C
```{r}
mgrB <- plot_gene(tally_reads, gene = gff %>% filter(gene == "mgrB"), pad = 0, intern = 100)

mgrB
ggsave(plot = last_plot(),filename = "/data2/sangeev/paper1/updated_June24/figures/Fig1C.png", dpi = 600, width = 4, height = 3)
```
