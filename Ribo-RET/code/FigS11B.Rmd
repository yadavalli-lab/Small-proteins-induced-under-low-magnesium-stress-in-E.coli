...
#Figure S11B
```{r}
plot_gene(tally_reads, gene = gff %>% filter(gene == "hfq"), pad = 0, intern = 100)
ggsave(plot = last_plot(),filename = "/data2/sangeev/paper1/updated_June24/figures/FigS11B.png", dpi = 600, width = 4, height = 3)
```
