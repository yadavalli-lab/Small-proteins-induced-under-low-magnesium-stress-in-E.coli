...
ggsave(plot = last_plot(),filename = "/data2/sangeev/paper1/updated_June24/figures/FigS9A.png", width = 5, height = 3, units = "in", dpi = 600)
```
...
ggsave(plot = last_plot(),filename = "/data2/sangeev/paper1/updated_June24/figures/FigS9C.png", width = 4.5, height = 2, units = "in", dpi = 600)
```
